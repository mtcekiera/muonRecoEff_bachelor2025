...
HISTOS = [
    {"name": "eps_pass",    "title": "eps_pass", "logy": True},
    {"name": "eps_total",     "title": "eps_total",   "logy": True},
    {"name": "eps_qEta_pass",      "title": "eps_qEta_pass",      "logy": False},
    {"name": "eps_qEta_total",     "title": "eps_qEta_total",   "logy": False},

    {"name": "tag_pt",      "title": "tag_pt", "logy": True},
    {"name": "tag_phi",     "title": "tag_phi", "logy": False},
    {"name": "tag_eta",     "title": "tag_eta", "logy": False},

    {"name": "probe_pt",    "title": "probe_pt", "logy": True},
    {"name": "probe_phi",   "title": "probe_phi", "logy": False},
    {"name": "probe_eta",   "title": "probe_eta", "logy": False},
    
    {"name": "probe_aco_presel",    "title": "probe_aco_presel", "logy": True},
    {"name": "probe_aco_postsel",   "title": "probe_aco_postsel", "logy": True},
    {"name": "probe_d0_presel",     "title": "probe_d0_presel", "logy": True},
    {"name": "probe_d0_postsel",    "title": "probe_d0_postsel", "logy": True},


    {"name": "TPpair_pt_presel",    "title": "TPpair_pt_presel", "logy": True},
    {"name": "TPpair_pt_postsel",   "title": "TPpair_pt_postsel", "logy": True},
    {"name": "TPpair_dR_presel",    "title": "TPpair_dR_presel", "logy": True},
    {"name": "TPpair_dR_postsel",   "title": "TPpair_dR_postsel", "logy": True},
    {"name": "TPpair_M_presel",     "title": "TPpair_M_presel", "logy": True},
    {"name": "TPpair_M_postsel",    "title": "TPpair_M_postsel",   "logy": True}
]
