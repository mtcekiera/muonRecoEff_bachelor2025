...
def main():
    ...
    if save_all:
        histogram_params = [
            ...
            Entry("probe_qeta_presel", 100, -3, 3),
            Entry("probe_qeta_postsel", 100, -3, 3),
        ...
        hist_dR_short = ROOT.TH1D('probe_dR_postsel_shortrange', 'dR on a shorter range', 100, 0, 0.005)
    ...
    for event in tree:
        ...
        if save_all:
            ...
            for val_pt_pre, val_dR_pre in zip(vals_pt_pre, vals_dR_pre):
            ...
            for val_pair_pt_pre, val_pair_aco_pre in zip(vals_pair_pt_pre, vals_pair_aco_pre):
            ...
            for val_pt, val_qeta in zip(vals_pt_pass,vals_qeta_pass):
            ...
            for val_pt, val_qeta in zip(vals_pt_total, vals_qeta_total):
